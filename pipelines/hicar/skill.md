...
- `MACS2_peak_calling_options` (5 parameters)
- `MAPS_peak_calling_options` (13 parameters)
- `Other_options_not_expose_yet` (5 parameters)
- `Visualization_options` (4 parameters)
- `experiment_config_options` (3 parameters)
- `generic_options` (11 parameters)
- `input_output_options` (6 parameters)
- `institutional_config_options` (6 parameters)
- `max_job_request_options` (3 parameters)
- `pipeline_controls` (6 parameters)
- `reference_genome_options` (12 parameters)

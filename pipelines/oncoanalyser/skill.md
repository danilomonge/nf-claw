...
- **Other options** (`other_options`) — 34 parameters
- **Reference data options** (`reference_data_options`) — 18 parameters
...
```bash
nfclaw run oncoanalyser ... --nxf-ver 25.10.4
```
...
The exact output files and directory layout for this release are documented upstream: https://github.com/nf-core/oncoanalyser/blob/3.0.0/docs/output.md
...
Full list with references: https://github.com/nf-core/oncoanalyser/blob/3.0.0/CITATIONS.md
...
## Full reference
Every parameter — name, type, required, hidden, allowed values, constraints, default and description — is in [reference.md](reference.md). Use it as the source of truth; do not guess flags. Nextflow's nf-schema validates every parameter against this schema at runtime, so an unknown or invalid value fails fast. Upstream usage: https://github.com/nf-core/oncoanalyser/blob/3.0.0/docs/usage.md

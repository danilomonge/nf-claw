...
```bash
nfclaw run pixelator ... --nxf-ver 25.10.4
```
...
The exact output files and directory layout for this release are documented upstream: https://github.com/nf-core/pixelator/blob/5.0.1/docs/output.md

## Tools this pipeline runs
The tools/methods this pipeline runs, per the authors' own list: pixelator, cutadapt, fastp.

Full list with references: https://github.com/nf-core/pixelator/blob/5.0.1/CITATIONS.md
...
## Full reference
Every parameter — name, type, required, hidden, allowed values, constraints, default and description — is in [reference.md](reference.md). Use it as the source of truth; do not guess flags. Nextflow's nf-schema validates every parameter against this schema at runtime, so an unknown or invalid value fails fast. Upstream usage: https://github.com/nf-core/pixelator/blob/5.0.1/docs/usage.md
